...
namespace ArtForAll.PerformancePB.Code
{
    public static class FilePermissionsChecker
    {
        ...
        /// <summary>
        /// Loads the ACL(Access control list) file once at startup for better performance
        /// </summary>
        /// <param name="aclPath">The optional path to the ACL</param>
        public static void LoadACL(string aclPath = @"D:\repositories\ArtForAll-Events-Utilities\ArtForAll.PerformancePlayBook\permsfile.txt")
        {
